...
export const metadata: Metadata = {
  title: 'プライバシーポリシー - IT言葉',
  description: 'IT言葉（以下、「当サイト」といいます。）におけるプライバシー情報の取扱いについて、以下のとおりプライバシーポリシー（以下、「本ポリシー」といいます。）を定めます。',
  robots: {
          ...
          <main className="lg:w-3/4">
            ...
            <article className="bg-white rounded-lg shadow-md p-8">
              ...
              <div className="prose max-w-none">
                <p>IT言葉（以下、「当サイト」といいます。）は、当サイトの提供するサービスにおける、ユーザーの個人情報を含むプライバシー情報の取扱いについて、以下のとおりプライバシーポリシー（以下、「本ポリシー」といいます。）を定めます。</p>
